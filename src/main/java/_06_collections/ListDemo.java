...
public class ListDemo {	
	...
	private static List<Integer> arrayListDemo() {
		...
		System.out.println("list1: " + list1);
		list1.set(0, 9);
		System.out.println("list1: (after set op) " + list1);
		...
		list3.set(0, 6);
		System.out.println("list1: (after setting list in list3) " + list1);
		list3.add(0, 7);
		System.out.println("list1: " + list1);
		list1.set(2, 8);
		System.out.println("list3: " + list3);
	...
	private static void iteratorDemo(List<Integer> list1) {
		...
		/*
		  list iterator implements iterator interface,
			to get instance of iterator, we need to call constructor of
			interator interface on the list instance that we created
		*/
